...
abstract class BaseVerificationViewModel(
    ...
    private val _isApplicable = MutableLiveData<Boolean>()
    val isApplicable: LiveData<Boolean> = _isApplicable
    ...
    abstract fun handleDecodeResult(decodeResult: DecodeResult)
