...
import dgca.verifier.app.android.diia.DiiaProcessor
...
class DccModule {
    ...
    @Singleton
    @Provides
    fun provideSchemaValidator(): SchemaValidator = DefaultSchemaValidator(DIIA_UA_JSON_SCHEMA_V1)
