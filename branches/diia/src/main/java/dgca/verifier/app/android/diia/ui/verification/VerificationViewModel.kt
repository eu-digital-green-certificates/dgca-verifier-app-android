 ...
 *  ---license-end
 *
 *  Created by osarapulov on 3/17/22, 2:05 PM
 */
...
import dgca.verifier.app.android.diia.model.rules.toRuleValidationResultModels
import dgca.verifier.app.android.diia.model.toCertificateModel
import dgca.verifier.app.android.diia.settings.debug.mode.DebugModeState
import dgca.verifier.app.android.diia.ui.verification.model.*
    ...
    private suspend fun validateCertificate(
        ...
        certificates.forEach { innerCertificate ->
            ...
            if (verificationResult.coseVerified) {
                ...
                if (false && expirationTime != null && currentTime.isAfter(expirationTime)) {
