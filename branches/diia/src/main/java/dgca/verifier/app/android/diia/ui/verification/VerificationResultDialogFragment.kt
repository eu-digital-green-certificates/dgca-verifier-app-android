...
import com.android.app.diia.databinding.DialogFragmentVerificationResultBinding
import dagger.hilt.android.AndroidEntryPoint
import dgca.verifier.app.android.diia.model.CertificateModel
import dgca.verifier.app.android.diia.model.TestResult
import dgca.verifier.app.android.diia.model.UaCertificateModel
...
class VerificationResultDialogFragment : BaseVerificationDialogFragment<DialogFragmentVerificationResultBinding>() {
    ...
    private fun handleVerificationResult(
        ...
        certificateModel.uaCertificateModel?.showUaCertificate()
    ...
    private fun UaCertificateModel.showUaCertificate() {
        binding.uaCertificate.root.visibility = View.VISIBLE
        binding.uaCertificate.docTypeValue.text = docType
        binding.uaCertificate.genderValue.text = genderEN
        binding.uaCertificate.docNumberValue.text = docNumber
        binding.uaCertificate.middleNameValue.text = middleNameUA
        binding.uaCertificate.registrationValue.text = registration
        binding.uaCertificate.nationalityValue.text = nationalityEN
    }
