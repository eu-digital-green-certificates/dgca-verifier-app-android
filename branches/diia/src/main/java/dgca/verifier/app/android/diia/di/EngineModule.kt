 ...
 *  ---license-end
 *
 *  Created by osarapulov on 3/17/22, 2:46 PM
 */
...
import dgca.verifier.app.android.diia.data.local.DefaultEnginePreferences
import dgca.verifier.app.android.diia.data.local.Preferences
import dgca.verifier.app.android.diia.data.local.countries.CountriesDao
import dgca.verifier.app.android.diia.data.local.countries.DefaultCountriesLocalDataSource
import dgca.verifier.app.android.diia.data.local.rules.DefaultRulesLocalDataSource
import dgca.verifier.app.android.diia.data.local.rules.EngineDatabase
import dgca.verifier.app.android.diia.data.local.rules.RulesDao
import dgca.verifier.app.android.diia.data.local.valuesets.DefaultValueSetsLocalDataSource
import dgca.verifier.app.android.diia.data.local.valuesets.ValueSetsDao
import dgca.verifier.app.android.diia.data.remote.countries.CountriesApiService
import dgca.verifier.app.android.diia.data.remote.countries.DefaultCountriesRemoteDataSource
import dgca.verifier.app.android.diia.data.remote.rules.DefaultRulesRemoteDataSource
import dgca.verifier.app.android.diia.data.remote.rules.RulesApiService
import dgca.verifier.app.android.diia.data.remote.valuesets.DefaultValueSetsRemoteDataSource
import dgca.verifier.app.android.diia.data.remote.valuesets.ValueSetsApiService
...
object EngineModule {
    ...
    fun provideAffectedFieldsDataRetriever(objectMapper: ObjectMapper): AffectedFieldsDataRetriever =
        DefaultAffectedFieldsDataRetriever(objectMapper.readTree(DIIA_UA_JSON_SCHEMA_V1), objectMapper)
