...
/**
 * [VcPreferences] impl backed by [android.content.SharedPreferences].
 */
class VcPreferencesImpl(context: Context) : VcPreferences {
    ...
    companion object {
        ...
        private const val KEY_TRUST_LIST_SYNC = "dgca.verifier.app.vc.trustList"
    }
}
